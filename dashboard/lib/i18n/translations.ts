...
export const translations = {
  en: {
    ...
    "ssl.nextCheck": "Next check",
    "ssl.created": "Added",
    "ssl.history": "Check History",
    "ssl.historyLoading": "Loading history...",
  ...
  es: {
    ...
    "ssl.cipher": "Cifrado",
    "ssl.serial": "Serial",
    "ssl.fingerprint": "Huella",
    "ssl.validFrom": "Válido desde",
    "ssl.nextCheck": "Próximo check",
    "ssl.created": "Agregado",
    "ssl.history": "Historial de Checks",
    "ssl.historyLoading": "Cargando historial...",
